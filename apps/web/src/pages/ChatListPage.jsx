  ...
  return (
    <div className="px-4 pt-6">
      ...
      {!loading && conversations.length === 0 && (
        <p className="text-center text-gray-400">No conversations yet. Match with someone first!</p>
      )}
      ...
      <div className="space-y-2 pb-4">
        {conversations.map((c) => {
          ...
          return (
            ...
            >
              <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gray-800 text-xl">
